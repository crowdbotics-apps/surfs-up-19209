"""surfs_up_19209 URL Configuration
...
admin.site.site_header = "Surfs Up"
admin.site.site_title = "Surfs Up Admin Portal"
admin.site.index_title = "Surfs Up Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Surfs Up API",
        default_version="v1",
        description="API documentation for Surfs Up App",
    ),
    public=True,
